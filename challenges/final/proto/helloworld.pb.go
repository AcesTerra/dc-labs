...
var file_helloworld_proto_rawDesc = []byte{
	...
	0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x12, 0x3a, 0x0a, 0x04, 0x54, 0x65, 0x73, 0x74, 0x12, 0x18,
	...
	0x22, 0x00, 0x42, 0x30, 0x0a, 0x1b, 0x69, 0x6f, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x65, 0x78,
...
var file_helloworld_proto_depIdxs = []int32{
	...
	0, // 1: helloworld.Greeter.Test:input_type -> helloworld.HelloRequest
	1, // 2: helloworld.Greeter.SayHello:output_type -> helloworld.HelloReply
	1, // 3: helloworld.Greeter.Test:output_type -> helloworld.HelloReply
...
func (c *greeterClient) Test(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
...
func (*UnimplementedGreeterServer) Test(context.Context, *HelloRequest) (*HelloReply, error) {
...
func _Greeter_Test_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).Test(ctx, req.(*HelloRequest))
	}
	return interceptor(ctx, in, info, handler)
}
